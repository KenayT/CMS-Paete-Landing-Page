...
<head>
    <meta charset="UTF-8">
    <title>Edit: What We Offer - Paete CMS</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .link-item { display: grid; grid-template-columns: 1fr auto auto; gap: 8px; margin-bottom: 8px; align-items: center; }
        .add-row { display: grid; grid-template-columns: 1fr auto; gap: 8px; margin-top: 1rem; padding-top: 1rem; border-top: 1px dashed #1e293b; }
...
<body>
    ...
    <main>
        <h1 class="page-title">Edit: What We Offer</h1>
        <div class="card" id="card-general"></div>
        <div class="card" id="card-loans"></div>
        <div class="card" id="card-deposits"></div>
    </main>

    <div id="toast"></div>

    <script type="module" src="../pages/offerings.js?v=1"></script>
</body>
</html>